...
use crate::actions::scrap_profile::scrap_each_profile_new::{
    scrap_each_profile, send_search_status,
};
...
async fn run_loop(
    ...
    for url in urls {
        ...
        let browser2 = Arc::new(RwLock::new(browser));

        let browser_clone = Arc::clone(&browser2.clone());
